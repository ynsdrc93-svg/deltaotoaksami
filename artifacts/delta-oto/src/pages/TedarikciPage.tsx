  ...
  tr: {
    ...
    advantages: {
      ...
      items: [
        ...
        { title: "Groupauto Tedarik Ayrıcalığı", desc: "Groupauto International üyeliği; 40+ ülkedeki 3.000+ üye firma gücünü satın alma kaldıracımıza dönüştürür. Global fiyat avantajı doğrudan portföyümüze yansır." },
  ...
  en: {
    ...
    advantages: {
      ...
      items: [
        ...
        { title: "GROUPAUTO Purchasing Advantage", desc: "Our GROUPAUTO International membership turns the strength of 3,000+ member companies across 40+ countries into purchasing leverage, translating directly into portfolio-wide price advantages." },

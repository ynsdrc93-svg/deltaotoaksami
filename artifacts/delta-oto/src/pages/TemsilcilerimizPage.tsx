    ...
    <div className="do-site bg-white min-h-screen">
      ...
      <section className="relative min-h-[560px] flex items-center text-white overflow-hidden bg-[#0e1016]">
        ...
        <div className="w-full max-w-7xl mx-auto px-6 lg:px-8 relative z-10 py-14 lg:py-20 text-center flex flex-col items-center">
          ...
          <h1 ref={reveal} className="do-reveal do-d1 text-4xl md:text-5xl lg:text-6xl font-black leading-[1.08] tracking-[-0.02em] mb-4 lg:mb-6 max-w-2xl">
          ...
          <p ref={reveal} className="do-reveal do-d2 text-[17px] text-gray-300 leading-[1.8] max-w-xl font-light mb-6 lg:mb-10">
            {t.hero.body}
          </p>
          <button
            ref={reveal}
      ...
      <section className="bg-[#1B3A8F] py-12">
        <div ref={reveal} className="do-reveal max-w-7xl mx-auto px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">

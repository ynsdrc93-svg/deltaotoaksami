...
export const PRODUCT_CATEGORIES: ProductCategory[] = [
  ...
  { name: "Sinyalizasyon ve Görünürlük", icon: Eye, description: "Sinyal, uyarı ve görünürlük sistemlerinde araç güvenliğini tamamlayan ürün grubu.", brandSlugs: ["bosch", "cargo", "denso", "febi", "hella", "osram", "silbak", "swag", "valeo"], featuredBrandSlugs: ["bosch", "hella", "valeo", "osram", "silbak"] },
  ...
  { name: "Elektrik Donanımı", icon: Zap, description: "Araç elektroniği ve kablo donanımında geniş marka alternatifi.", brandSlugs: ["behr", "beru", "blueprint", "bosch", "cargo", "champion", "delphi", "denso", "era", "febi", "hlmando", "hella", "ina", "mahle", "ngk", "nrf", "optima", "osram", "spart", "swag", "valeo"], featuredBrandSlugs: ["bosch", "denso", "valeo", "hella", "ngk", "beru", "optima", "spart"] },
  ...
  { name: "Motor İç Aksamı", icon: Wrench, description: "Motor iç aksamı ve yapı parçalarında hassas mühendislik gerektiren kategori.", brandSlugs: ["borgwarner", "contitech", "corteco", "elring", "febi", "gates", "ina", "ioto", "kingpiston", "mahle", "rapro", "supsan", "swag", "taifun", "ucel"], featuredBrandSlugs: ["mahle", "borgwarner", "elring", "ina", "kingpiston", "ioto"] },

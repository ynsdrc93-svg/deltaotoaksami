...
export const CLASSIFIED_BRANDS: Brand[] = [
  ...
  { slug: "filtron", name: "Filtron", origin: "yerli", hasVerifiedLogo: true, logoFormat: "webp" },
  ...
  { slug: "monroe", name: "Monroe", website: "https://www.monroe.com/", origin: "yerli", hasVerifiedLogo: true, logoFormat: "webp" },
